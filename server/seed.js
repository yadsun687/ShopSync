...
const users = [
  ...
  {
    username: "editor1",
    email: "editor@shopsync.com",
    password: "password123",
    role: "editor",
  },
  {
    username: "staff1",
    email: "staff1@shopsync.com",
    password: "password123",
    role: "staff",
  },
  {
    username: "staff2",
    email: "staff2@shopsync.com",
    password: "password123",
    role: "staff",
  },
  {
    username: "janedoe",
    email: "jane@shopsync.com",
    password: "password123",
    role: "staff",
  },
];
  ...
  try {
    ...
    const orders = [
      ...
      },
      {
        ...
        quantity: 5,
        totalPrice: createdProducts[4].price * 5,
        status: "pending",
      },
      {
        productId: createdProducts[6]._id,
        quantity: 3,
        totalPrice: createdProducts[6].price * 3,
        status: "completed",
      },
      {
        productId: createdProducts[8]._id,
        quantity: 1,
        totalPrice: createdProducts[8].price * 1,
        status: "pending",
      },
    ];
        ...
        replies: [
          {
            ...
            replies: [
              {
                content: "What genre do you mostly listen to?",
    ...
    console.log(
      "Login credentials: email: admin@shopsync.com / password: password123",
    );
